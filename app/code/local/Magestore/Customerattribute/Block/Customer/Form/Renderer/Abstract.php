 ...
 */
abstract class Magestore_Customerattribute_Block_Customer_Form_Renderer_Abstract extends Mage_Core_Block_Template
{
    /**
     * Attribute instance
     *
    ...
    /**
     * Check show on register guset
     */
    protected  $_showOnGuest =TRUE;
    /**
    ...
    /**
     * Set show on page register guest
     */
    public function setShowOnGuest($show){
        $this->_showOnGuest= $show;
        return $this;
    }
    public function getShowOnGuest(){
        return $this->_showOnGuest;
    }
}
