 ...
 */
class Magestore_Customerattribute_Block_Adminhtml_Customerattribute_Edit_Tab_Options
    extends Mage_Adminhtml_Block_Widget
{
   ...
   public function __construct()
	...
	public function getAttributeObject()
    {
		...
		$attributeObjects = Mage::getModel('customer/attribute')->load($data['attribute_id']);
