 ...
 */
class Magestore_Customerattribute_Block_Adminhtml_Customerattribute extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_customerattribute';
        $this->_blockGroup = 'customerattribute';
        $this->_headerText = Mage::helper('customerattribute')->__('Manage Customer Attributes');
