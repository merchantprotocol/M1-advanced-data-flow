 ...
 */
class Innoexts_AdvancedDataflow_Model_Sales_Convert_Adapter_Order extends Mage_Eav_Model_Convert_Adapter_Entity
{
    /**
     * System fields
     * 
    ...
    {
        $store = $this->getVar('default_store', 'default');
     ...
     * @return boolean
     */
    protected function validateRow($entityType, $row)
    {
        $helper = $this->getHelper();
        $string = $this->getStringHelper();
