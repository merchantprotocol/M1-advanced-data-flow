...
/**
 * Order payment eav attribute collection resource
 * 
 * @category   Innoexts
 * @package    Innoexts_AdvancedDataflow
 * @author     Innoexts Team <developers@innoexts.com>
 */
class Innoexts_AdvancedDataflow_Model_Mysql4_Sales_Order_Payment_Attribute_Collection 
    extends Mage_Eav_Model_Mysql4_Entity_Attribute_Collection
{
     ...
     * @var string
     */
    protected $_entityTypeCode = 'sales_order_payment';
    /**
