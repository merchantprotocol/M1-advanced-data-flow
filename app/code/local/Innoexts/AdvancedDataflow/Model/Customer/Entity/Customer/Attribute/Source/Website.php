 ...
 */
class Innoexts_AdvancedDataflow_Model_Customer_Entity_Customer_Attribute_Source_Website 
    ...
    protected function _getOptions()
    {
        ...
        if (is_array($websites) && count($websites)) {
            foreach ($websites as $website) {
                array_push($options, array('value' => $website->getId(), 'label' => $website->getCode(), ));
            }
        }
        return $options;
    }
