...
//        Mage::log('----------- salesOrderCreditmemoSaveAfter ', null, 'avalara.log');
//        Mage::log( (!$creditmemo->getOrigData($creditmemo->getIdFieldName())), null, 'avalara.log');
//        Mage::log( (Mage::helper('avatax')->isObjectActionable($creditmemo)), null, 'avalara.log');
    ...
    public function cleanLog($schedule) {
        ...
        $connection->delete(
                Mage::getResourceModel('avatax_records/log')->getTable('avatax_records/log'), $connection->quoteInto('created_at < DATE_SUB(UTC_DATE(), INTERVAL ? DAY)', $days)
        );
    }
