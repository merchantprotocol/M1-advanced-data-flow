 ...
 */
class MP_AdvancedDataflow_Model_Sales_Convert_Adapter_Order extends MP_AdvancedDataflow_Model_Dataflow_Convert_Adapter_Entity 
{
    /**
     * Constructor
     */
    public function __construct()
    {
        ...
        $this->setVar('entity_model', 'advanceddataflow/sales_entity_order');
    }
    /**
     * Load collection identifiers
     * 
     * @return MP_AdvancedDataflow_Model_Sales_Convert_Adapter_Order
     */
