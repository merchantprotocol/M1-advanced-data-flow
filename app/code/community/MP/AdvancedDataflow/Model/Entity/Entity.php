 ...
 */
class MP_AdvancedDataflow_Model_Entity_Entity extends MP_AdvancedDataflow_Model_Entity_Abstract
{
     ...
     * Sort attributes
     *
     * @param MP_AdvancedDataflow_Model_Entity_Attribute $attribute1
     * @param MP_AdvancedDataflow_Model_Entity_Attribute $attribute2
     * @return int
     */
     ...
     * 
     * @param string $name
     * @param MP_AdvancedDataflow_Model_Entity_Entity $child
     * @return array
     */
     ...
     * @return MP_AdvancedDataflow_Model_Entity_Entity
     */
    protected function setChildData($data, $name, MP_AdvancedDataflow_Model_Entity_Entity $child)
    {
