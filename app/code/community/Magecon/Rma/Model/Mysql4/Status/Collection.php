 ...
 */
class Magecon_Rma_Model_Mysql4_Status_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function arrangeStatuses() {
        $data = $this->getData();
        return usort($data, 'compareOrder');
    }
