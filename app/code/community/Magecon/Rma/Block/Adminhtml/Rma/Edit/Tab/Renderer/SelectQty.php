 ...
 */
class Magecon_Rma_Block_Adminhtml_Rma_Edit_Tab_Renderer_SelectQty extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $order = Mage::getModel('sales/order')->load(Mage::getModel('rma/rma')->load($row->getData('rma_id'))->getOrderId());
